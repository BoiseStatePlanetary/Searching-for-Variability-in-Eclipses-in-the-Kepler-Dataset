...
\subsection{Model}
After applying the above conditioning procedure, we fit a series of photometric models to all the available data. We first analyzed the transit portion of Kepler-76 b's light curve since it is much more sensitive to the orbital parameters than the out-of-transit portion. We folded all data on the best-fit period reported by \citet{2013ApJ...771...26F} and fit a standard transit curve \citep{2002ApJ...580L.171M}\footnote{As implemented in PyAstronomy -- \url{https://github.com/sczesla/PyAstronomy}.} to the portion of the time-series within two transit durations of the reported mid-transit time, without accounting for the other photometric signals (planetary phase curve, ellipsoidal variations, etc.) since they are much smaller in magnitude. 
